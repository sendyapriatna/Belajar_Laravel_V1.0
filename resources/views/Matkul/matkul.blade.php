...
<body>
    <div class="container">
        ...
        <div class="l-right">
            <div class="title">
                <h2 class="fw-bold mt-5">Data Mata Kuliah</h2>
            </div>
                    ...
                    <table class="table table-bordered">
                        ...
                        <tbody class="color-white color-neutral-400">
                            ...
                            <tr class="text-center">
                                ...
                                <td class="col-1 td1">{{ $value->sks}}</td>
                                <td class="col-2 text-center">
                                    <a href="/matkul/editMatkul/{{ $value->id }}" class="btn">
                                    ...
                                    <a href="/matkul/hapusMatkul/{{ $value->id }}" class="btn">
